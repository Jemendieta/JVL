...
<div class="app-sidebar__overlay" data-toggle="sidebar"></div>
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            <li><a class="app-menu__item" href=""><i class="app-menu__icon bi bi-speedometer"></i><span class="app-menu__label">Inicio</span></a></li>
            
            
            
            <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-laptop"></i><span class="app-menu__label">Registro de usuarios</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="bootstrap-components.html"><i class="icon bi bi-circle-fill"></i> Nuevo administrador</a></li>
                ...
                <li><a class="treeview-item" href=""><i class="icon bi bi-circle-fill"></i> Cards</a></li>
                <li><a class="treeview-item" href=""><i class="icon bi bi-circle-fill"></i> Widgets</a></li>
            </ul>
            </li>
            ...
            <ul class="treeview-menu">
                <li><a class="treeview-item active" href="#"><i class="icon bi bi-circle-fill"></i> Blank Page</a></li>
